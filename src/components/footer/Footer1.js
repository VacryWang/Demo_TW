    ...
    return (
        <div>
            <div className={"text-4xl p-8 bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200"}>
                <div className={"text-center font-bold"}>Footer 1 :</div>
            </div>
            <footer className="text-gray-600 body-font">
                ...
                <div className="bg-gray-100">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 Company —
                            <a href="https://google.com/" rel="noopener noreferrer" class="text-gray-600 ml-1"
