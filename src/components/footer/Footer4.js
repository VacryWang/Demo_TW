    ...
    return (
        <div>
            <div className={"text-4xl p-8 bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 mt-16"}>
                <div className={"text-center font-bold"}>Footer 4 :</div>
            </div>
            <footer className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap md:text-left text-center order-first">
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <p className="text-gray-500 text-sm mt-2 md:text-left text-center">Bitters chicharrones
                                fanny pack
                ...
                <div className="bg-gray-100">
                    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                        ...
                        <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2024 Company —
                            <a href="https://google.com/" rel="noopener noreferrer" className="text-gray-600 ml-1"
                               target="_blank">@Person</a>
                        </p>
