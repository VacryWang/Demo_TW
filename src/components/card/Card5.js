    ...
    return (
        <div>
            <div className={"text-4xl p-8 bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200"}>
                <div className={"text-center font-bold"}>Card 5 :</div>
            </div>
                        ...
                        <div className="py-8 px-4 lg:w-1/3">
                            <div className="h-full flex items-start">
                                <div className="w-12 flex-shrink-0 flex flex-col text-center leading-none">
                                    ...
                                    <span
                                        className="font-medium text-lg text-gray-800 title-font leading-none">18</span>
                                </div>
                                <div className="flex-grow pl-6">
                                    ...
                                    <p className="leading-relaxed mb-5">Photo booth fam kinfolk cold-pressed sriracha
                ...
                <span className="title-font font-medium text-gray-900">Alper Kamu</span>
                        ...
                        <div className="py-8 px-4 lg:w-1/3">
                            <div className="h-full flex items-start">
                                ...
                                <div className="flex-grow pl-6">
                                    <h2 className="tracking-widest text-xs title-font font-medium text-indigo-500 mb-1">CATEGORY</h2>
                                    <h1 className="title-font text-xl font-medium text-gray-900 mb-3">Shooting
                                        Stars</h1>
                                    <p className="leading-relaxed mb-5">Photo booth fam kinfolk cold-pressed sriracha
                                        leggings jianbing microdosing tousled waistcoat.</p>
                                    <div className="inline-flex items-center">
                        ...
                        <div className="py-8 px-4 lg:w-1/3">
                            <div className="h-full flex items-start">
                                ...
                                <div class="flex-grow pl-6">
                                    ...
                                    <p class="leading-relaxed mb-5">Photo booth fam kinfolk cold-pressed sriracha
                                        leggings jianbing microdosing tousled waistcoat.</p>
