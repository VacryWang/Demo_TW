    ...
    return (
        <div>
            <div className={"text-4xl p-8 bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 mb-16"}>
                <div className={"text-center font-bold"}>Card 43 :</div>
            </div>
            <div
               ...
               stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                    ...
                    <div class="mt-5 max-w-2xl text-center mx-auto">
                        <h1 class="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-gray-200">
                            Let's Build
                            <span
                                class="bg-clip-text bg-gradient-to-tl from-blue-700 to-blue-400 text-transparent"> Together</span>
                        </h1>
                    </div>
                    ...
                    <div class="mt-8 gap-3 flex justify-center">
                        ...
                        <button type="button"
                            ...
                            $ npm i preline
                            <span
                                class="flex justify-center items-center bg-gray-200 rounded-md size-7 dark:bg-gray-700 dark:text-gray-400">
          <svg class="flex-shrink-0 size-4 group-hover:rotate-6 transition" xmlns="http://www.w3.org/2000/svg"
              ...
              d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/></svg>
                    ...
                    <div class="mt-5 flex justify-center items-center gap-x-1 sm:gap-x-3">
                        ...
                        <span class="inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 hover:underline font-medium"
                           href="#">
                            Installation Guide
                            <svg class="flex-shrink-0 size-4" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <path
