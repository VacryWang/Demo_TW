    ...
    return (
        <div>
            <div className={"text-4xl p-8 bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200"}>
                <div className={"text-center font-bold"}>Card 19 :</div>
            </div>
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <h1 className="sm:text-3xl text-2xl font-medium title-font text-center text-gray-900 mb-20">Raw
                        Denim Heirloom Man Braid
                        ...
                        <div className="p-4 md:w-1/3 flex">
                            ...
                            <div className="flex-grow pl-6">
                                ...
                                <p className="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four
                                    dollar toast vegan taxidermy. Gastropub indxgo juice poutine, ramps microdosing banh
                                    mi pug VHS try-hard ugh iceland kickstarter tumblr live-edge tilde.</p>
                                <div className="mt-3 text-indigo-500 inline-flex items-center">Learn More
                        ...
                        <div className="p-4 md:w-1/3 flex">
                            ...
                            <div class="flex-grow pl-6">
                                ...
                                <p class="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar
                                    ...
                                    VHS try-hard ugh iceland kickstarter tumblr live-edge tilde.</p>
