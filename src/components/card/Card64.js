    ...
    return(
        <div>
            <div className={"text-4xl p-8 bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200"}>
                <div className={"text-center font-bold"}>Card 64 :</div>
            </div>
                                ...
                                <div class="p-4 bg-gray-100 rounded-b-xl md:px-7 dark:bg-slate-700">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            <img class="size-8 rounded-full sm:h-[2.875rem] sm:w-[2.875rem] opacity-80" src="https://dummyimage.com/100x100" alt="Description"/>
                                        </div>
